...
<a id="trellistrellis"></a>

## `@trellis/trellis`

需要：`storageDomain` · `tools` · `web` · `systemPrompt`
...
来源：[`packages/trellis/trellis/src/index.ts:72`](../packages/trellis/trellis/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-trellis-browser`（[`packages/client/ui-trellis-browser/src/index.ts`](../packages/client/ui-trellis-browser/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-trellis-graph`（[`packages/client/ui-trellis-graph/src/index.ts`](../packages/client/ui-trellis-graph/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-trellis-knowledge`（[`packages/client/ui-trellis-knowledge/src/index.ts`](../packages/client/ui-trellis-knowledge/src/index.ts)）
