...
flowchart LR
  ...
  pkg_trellis["trellis"]
  svc_trellisKnowledge["ctx.trellisKnowledge<br/>Trellis knowledge base and graph service"]
  ...
  pkg_tools --> svc_tools
  pkg_trellis --> svc_trellisKnowledge
  ...
  svc_trellisKnowledge --> pkg_trellis
...
| `ctx.trellisKnowledge` | `core` | `trellis` | - | `trellis` | - | 带有来源溯源的文档归档、关系索引、文本检索以及基于 SQLite storageDomain 的有界图谱投影。 |
