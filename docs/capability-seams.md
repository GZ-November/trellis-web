...
| `ctx.trellisKnowledge` | `core` | `trellis` | - | `trellis` | - | Source-backed document archiving, relation indexing, text search, and bounded graph projections backed by SQLite storageDomain. |
