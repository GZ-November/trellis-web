...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-trellis-knowledge TrellisKnowledgeDock id \'trellis_knowledge_dock\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-trellis-browser TrellisBrowserDrawer id \'trellis_browser_drawer\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-trellis-knowledge TrellisKnowledgeView id \'trellis_knowledge\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, glob, grep, read, skill, todo_write, trellis_graph, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'client-ui-trellis-graph TrellisGraphRow key \'trellis_graph\'',
