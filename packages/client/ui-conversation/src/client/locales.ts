...
export const zh = {
  ...
  'document.dropTitle': '拖入图片、文本或 PDF 文档即可添加',
  'document.dropDesc': '文本文档最大 1MB；图片最多 {count} 张，每张 {size}；其他文档自动上传整理',
  'document.dropBlocked': '当前无法添加文件',
  'document.unsupportedType': '目前支持图片以及 Markdown、TXT、HTML、JSON、CSV、XML、YAML、Org 文本文档',
  'document.tooLarge': '文本文档不能超过 1MB',
  'document.readFailed': '无法读取文本文档，请重新选择后再试',
  'image.pending': '待发送图片',
...
export const en = {
  ...
  'document.dropTitle': 'Drop images, text, or PDF documents to add them',
  'document.dropDesc': 'Text documents up to 1MB; up to {count} images, {size} each; other documents are uploaded and organized',
  'document.dropBlocked': 'Files cannot be added right now',
  'document.unsupportedType': 'Currently supports images and Markdown, TXT, HTML, JSON, CSV, XML, YAML, and Org text documents',
  'document.tooLarge': 'Text documents must be smaller than 1MB',
  'document.readFailed': 'The text document could not be read; choose it again and retry',
