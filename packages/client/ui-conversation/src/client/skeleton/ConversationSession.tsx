...
export function ConversationSessionHeader({
  ...
  const isCustomView = selectedId !== null && selectedId !== 'chat'
  const hideChrome = blank && composerPhase === 'blank' && !isCustomView
...
export function ConversationSession({
  ...
  useEffect(() => {
    ...
    window.addEventListener('trellis:switch-view', handleSwitch)
    return () => { window.removeEventListener('trellis:switch-view', handleSwitch) }
  }, [actions])

  if (blank && composerPhase === 'blank' && !isCustomView) return null
  return (
