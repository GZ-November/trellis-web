...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-trellis-graph': { kind: 'none', reason: 'Browser-side toolview plugin layer; registers nothing model-facing.' },
  'packages/client/ui-trellis-shell': { kind: 'none', reason: 'Browser-side full-screen workbench shell; registers nothing model-facing.' },
  'packages/client/ui-trellis-browser': { kind: 'none', reason: 'Browser-side view plugin layer; registers nothing model-facing.' },
  'packages/client/ui-trellis-knowledge': { kind: 'none', reason: 'Browser-side knowledge hub view plugin layer; registers nothing model-facing.' },
