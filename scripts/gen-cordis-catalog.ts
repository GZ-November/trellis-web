...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  TrellisIngestRequest: 'Trellis knowledge ingest payload is owned by packages/trellis/trellis/README.md',
  TrellisIngestResult: 'Trellis knowledge ingest receipt is owned by packages/trellis/trellis/README.md',
  TrellisSearchHit: 'Trellis knowledge search hit is owned by packages/trellis/trellis/README.md',
  TrellisDocumentId: 'Trellis document identifier is owned by packages/trellis/trellis/README.md',
  TrellisDocumentRead: 'Trellis document read record is owned by packages/trellis/trellis/README.md',
  KnowledgeDocumentRecord: 'Trellis document record is owned by packages/trellis/trellis/README.md',
  KnowledgeRelationRecord: 'Trellis relation record is owned by packages/trellis/trellis/README.md',
  TrellisRelationInput: 'Trellis relation input is owned by packages/trellis/trellis/README.md',
  TrellisGraphRequest: 'Trellis graph request is owned by packages/trellis/trellis/README.md',
  TrellisGraphSnapshot: 'Trellis graph snapshot is owned by packages/trellis/trellis/README.md',
}
